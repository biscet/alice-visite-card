...
const maskIcons = ["123.svg", "1234.svg"];
...
export default function Page() {
  ...
  // Loading state
  const [areExternalResourcesLoaded, setAreExternalResourcesLoaded] =
    useState(false);
  ...
  useEffect(() => {
    const loadResources = async () => {
      try {
        ...
        const allSvgs = [
          ...linkIcons.map((i) => `/images/icons/${i}`),
          ...maskIcons.map((i) => `/images/${i}`),
        ];
        const svgPromises = allSvgs.map(
          (src) =>
            new Promise((resolve) => {
              const img = new Image();
              img.src = src;
  ...
  const isPageReady =
    areExternalResourcesLoaded && loadedImageCount >= totalMainImages;
  ...
  const getScaleForIcon = (index: number) => {
    ...
    const adjustedScale =
      magnification.baseScale +
      proximity * (magnification.maxScale - magnification.baseScale);
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ position: "relative", height: isMobile ? 500 : 550 }}
      >
        {/* About Card Group */}
        <motion.div
        ...
        >
          <div className={styles.cardPrimary}>
            ...
            <div className={styles.cardPrimaryContent}>
              <h1>
                Привет! Меня зовут Алиса, мне 22 года, я графический дизайнер.
              </h1>
              ...
              <div className={styles.scrollableText}>
                ...
                <p>
                  ...
                  . Мечтаю посетить все самые значимые{" "}
                  <a
                    href="https://t.me/akeishapage/819"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={styles.textLink}
                  >
                ...
                <p>
                  По основному образованию я системный администратор с опытом
                  веб-разработки, что даёт мне бонус, в качестве ускоренного
                  изучения новых программ и технического взгляда на многие вещи.
                </p>
              </div>
              <div className={styles.divider}></div>
              <div
            ...
            <div className={styles.linksContainer}>
              ...
              >
                <div
                  ...
                  style={{
                    WebkitMaskImage: `url(/images/icons/telegram.svg)`,
                    maskImage: `url(/images/icons/telegram.svg)`,
                  }}
                />
              ...
              <a
                href="https://t.me/akeiha_dsgnhack"
                className={styles.linkButton}
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <div className={styles.splitButtons}>
                ...
                >
                  <div
                    className={styles.linkButtonIcon}
                    style={{
                      WebkitMaskImage: `url(/images/icons/dpofile.svg)`,
                      maskImage: `url(/images/icons/dpofile.svg)`,
                    }}
                  />
                  <span>Dprofile</span>
                </a>
                <a
                  href="https://www.behance.net/alisakurlapova"
                  className={styles.linkButton}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <div
                    className={styles.linkButtonIcon}
                    style={{
                      WebkitMaskImage: `url(/images/icons/behance.svg)`,
                      maskImage: `url(/images/icons/behance.svg)`,
                    }}
                  />
                  <span>Behance</span>
                </a>
              ...
              <a
                href="https://ru.pinterest.com/akeishapage/"
                className={styles.linkButton}
                target="_blank"
                rel="noopener noreferrer"
              >
                <div
                  className={styles.linkButtonIcon}
                  style={{
                    WebkitMaskImage: `url(/images/icons/pinterest.svg)`,
                    maskImage: `url(/images/icons/pinterest.svg)`,
                  }}
                />
                <span>Pinterest</span>
              </a>
              ...
              >
                <div
                  className={styles.linkButtonIcon}
                  style={{
                    WebkitMaskImage: `url(/images/icons/dysigners.svg)`,
                    maskImage: `url(/images/icons/dysigners.svg)`,
                  }}
                />
                <span>Дизайнерс</span>
              </a>
              ...
              >
                <div
                  className={styles.linkButtonIcon}
                  style={{
                    WebkitMaskImage: `url(/images/icons/vk.svg)`,
                    maskImage: `url(/images/icons/vk.svg)`,
                  }}
                />
                <span>Группа ВК (резерв)</span>
              </a>
            </div>
          </div>
        </motion.div>
